...
from .api.v1.endpoints.chats import router as chats_router  # Only import chats
...
app.include_router(chats_router, prefix="/api/chats", tags=["chats"])  # Single chats router
